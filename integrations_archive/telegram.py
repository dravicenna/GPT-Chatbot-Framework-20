...
def setup_routes(app, client, tool_data, assistant_id):
    ...
    def send_welcome(message):
        ...
        chat_mapping = core_functions.get_chat_mapping(
            "telegram", telegram_chat_id, assistant_id
        )
        ...
        if not chat_mapping:
            ...
            core_functions.update_chat_mapping(
                "telegram", telegram_chat_id, assistant_id, thread.id
            )
    ...
    def echo_all(message):
        ...
        db_entry = core_functions.get_chat_mapping(
            "telegram", telegram_chat_id, assistant_id
        )

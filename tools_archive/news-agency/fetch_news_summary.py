...
# Replace this URL with your own RSS.app URL
...
tool_config = {
    ...
    "function": {
        ...
        "description": "Fetch and summarize the latest three articles from a news feed.",
        "parameters": {
            "type": "object",
            "properties": {
                "confirm": {
        ...
        articles = [
            {
                ...
                "description": " ".join(
                    (strip_html(item.find("description").text) or "").split()[:50]
                ),
